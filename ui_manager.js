...
function displayMarketHub() {
    ...
    leagueSelector.addEventListener('change', () => {
        ...
        teamSelector.innerHTML = '<option value="">Clube</option>';
...
function renderMarketPlayerList(players) {
    ...
    let tableHTML = `<table><thead><tr><th>Nome</th><th>Clube</th><th>Idade</th><th>Pos.</th><th>GERAL</th><th>Valor de Mercado</th><th>Ação</th></tr></thead><tbody>`;
